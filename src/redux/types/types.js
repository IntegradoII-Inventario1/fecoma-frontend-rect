export const types = {
  ...
  uiCloseModalUpdateIngreso:'[ui] Close modal update ingreso',
  ...
  ingresoActive:'[ingreso] Set active producto',
  ingresoLoad:'[ingreso] Load producto',
  ingresoUpdated:'[ingreso] Update producto',
